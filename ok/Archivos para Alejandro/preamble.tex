...
\usepackage{multirow}
\usepackage{natbib}
\bibpunct{\textcolor{myblue}{(}}{\textcolor{myblue}{)}}{\textcolor{myblue}{;}}{a}{\textcolor{myblue}{,}}
{\textcolor{myblue}{,}}
...
% ------------------------------ Page Layout ------------------------------------
\usepackage[a4paper,text={15cm,24cm},bindingoffset=2cm,top=3cm,twoside]{geometry}
...
\usepackage[colorlinks=true,citecolor=myblue,linkcolor=black]{hyperref}
